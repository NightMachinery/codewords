...
- `frontend-theming.md` documents the app themes, including Dracula and Glitch homepage/board/card shaders, auto dark-mode switching, and moderator theme push.
