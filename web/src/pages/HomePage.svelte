<script lang="ts">
  ...
  import { normalizeNewRoomSettingsForCreate } from '../lib/gameplay';
  ...
  async function createRoom() {
    ...
    try {
      ...
      const created = await api.createRoom(authToken, normalizeNewRoomSettingsForCreate({ ...defaultSettings, ...savedSettings, seed: Date.now() }));
